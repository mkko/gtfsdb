exports.up = function (knex, Promise) {
    ...
    .createTable('agency_entry', function(table) {
      ...
      table.timestamps();
      table.string('agency_key').notNullable().unique();
    })
    
    .createTable('agency', function(table) {
      table.bigincrements('id').primary();
      table.biginteger('agency_entry_id').unsigned().notNullable().references('id').inTable('agency_entry').onDelete('CASCADE').index();
    ...
    .createTable('stop', function(table) {
      ...
      table.decimal('stop_lat', 16, 13).notNullable();
      table.decimal('stop_lon', 16, 13).notNullable();
    ...
    .createTable('route', function(table) {
      ...
      table.biginteger('agency_id').unsigned().references('id').inTable('agency').onDelete('CASCADE').index();
    ...
    .createTable('service', function(table) {
      ...
      table.string('service_id').notNullable().index();
    })
    ...
    .createTable('shape_sequence', function(table) {
      ...
      table.biginteger('shape_id').unsigned().notNullable().references('id').inTable('shape').onDelete('CASCADE').index();
      table.decimal('shape_pt_lat', 16, 13).notNullable();
      table.decimal('shape_pt_lon', 16, 13).notNullable();
    ...
    .createTable('trip', function(table) {
      ...
      table.string('trip_id').notNullable().index();
      table.biginteger('route_id').unsigned().notNullable().references('id').inTable('route').onDelete('CASCADE').index();
      table.biginteger('service_id').unsigned().notNullable().references('id').inTable('service').onDelete('CASCADE').index();
      table.string('trip_headsign');
      table.string('trip_short_name');
      table.integer('direction_id');
      table.string('block_id');
      table.biginteger('shape_id').unsigned().references('id').inTable('shape').onDelete('CASCADE').index();
    ...
    .createTable('stop_time', function(table) {
      ...
      table.biginteger('trip_id').unsigned().notNullable().references('id').inTable('trip').onDelete('CASCADE').index();
      table.string('arrival_time');
      table.string('departure_time');
      table.biginteger('stop_id').unsigned().notNullable().references('id').inTable('stop').onDelete('CASCADE').index();
